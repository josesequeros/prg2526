package com.sequeros.tableviewdemoaddnew;
...
public class App extends Application {
    ...
    public void start(Stage stage) {
        ...
        CheckBox chkDemocratic = new CheckBox("Es democrático?");
        Button btAddRow = new Button("Añadir nuevo");
        ...
        btAddRow.setOnAction(e -> {
            ...
            tfCapital.clear();
            tfPopulation.clear();
            //chkDemocratic.selectedProperty().setValue(Boolean.FALSE);
        ...
        stage.setTitle("TableViewDemoNew");
