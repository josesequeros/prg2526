...
public class VistaListaControlador implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        Personal misdatos = Auxiliar.leerPersonas("personal.csv");
        //misdatos.add(new Persona("Pepe", "García"));
        //misdatos.add(new Persona("María", "Pérez"));
        System.out.println(misdatos.getPersonal().size());
        ...
        datos = FXCollections.observableArrayList(misdatos.getPersonal());
