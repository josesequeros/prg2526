...
public class DatosPersonaControlador implements Initializable {
    ...
    public void initPersona(Persona p) {
        ...
        ObjectProperty<Residencia> residencia = p.getResidencia();
        tfCiudad.setText(residencia.getValue().getCiudad());
        tfProvincia.setText(p.getResidencia().getValue().getProvincia());
