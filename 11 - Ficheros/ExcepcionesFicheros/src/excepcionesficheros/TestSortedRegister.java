...
import excepcionesficheros.utiles.CorrectReading;
/**
...
public class TestSortedRegister {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File("excepcionesficheros/data/" + nameIn);
        in = new Scanner(f);
        f = new File("excepcionesficheros/data/" + "result.out");
        out = new PrintWriter(f);
        f = new File("excepcionesficheros/data/" + "result.log");
    ...
    public static void test1(int year, Scanner in, PrintWriter out) {
        ...
        if (n > 0) { 
           c.save(out); 
           System.out.println("Se han procesado " + n + " lí­neas.");
    ...
    /** MÃ©todo de prueba de add(Scanner, PrintWriter) y save(PrintWriter)
     *  de SortedRegister. Procesa los datos que se leen de in.
     *  Los datos procesados se guardan en out.
