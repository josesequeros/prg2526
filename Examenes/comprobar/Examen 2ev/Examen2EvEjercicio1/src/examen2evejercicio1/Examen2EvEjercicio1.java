...
public class Examen2EvEjercicio1 {
    ...
    public static void main(String[] args) {
        ...
        Persona persona = buscarPorCorreo(trabajadores, "becario11@contabilidad.es");
        if (persona != null) {
            if (persona instanceof Empleado || persona instanceof Becario) {
    ...
    private static Persona buscarPorCorreo(ArrayList<Persona> trabajadores, String email) {
        Persona aux = null;
        for (Persona t : trabajadores) {
            if (t.getCorreo().equals(email)) {
                aux = t;
                break;
            }
        }
