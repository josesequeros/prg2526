...
public class VistaListaControlador implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        datos = FXCollections.observableArrayList(Auxiliar.leerPersonas("personal.csv").getPersonal());
...
//        );
    ...
    @FXML
    private void paisAccion(ActionEvent event) {
    }
...
//view.setImage(null);
            if (item == null || empty) {
                ...
                } else if ("Male".equals(item.getGenero())) {
                    imagenGenero = "man.png";
                } else {
                    imagenGenero = "indefinido.png";
                }
                Image image;
                try {
