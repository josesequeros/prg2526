...
/**
 * Clase Colas: Cola de int. Implementaci�n enlazada.
 *
 * @author
 * @version
 */
public class Cola {
     ...
     *
     * @return boolean, true si la cola est� vac�a y false en caso contrario.
     */
    ...
    public void verCola() {
        ...
        System.out.println("Trabajos en Cola de Impresi�n:");
        while (aux != null) {
